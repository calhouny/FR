	   ...
	   jQuery('#adminForm').attr('action', 'admin.php?page=gallerys_huge_it_gallery&task=edit_cat&id=<?php echo $row->id; ?>&removeslide=<?php echo $rowimages->id; ?>');
			...
			function deleteproject<?php echo $rowimages->id; ?>() {
			   jQuery('#adminForm').attr('action', 'admin.php?page=gallerys_huge_it_gallery&task=edit_cat&id=<?php echo $row->id; ?>&removeslide=<?php echo $rowimages->id; ?>');
								...
								<div class="remove-image-container">
									<a onclick="deleteproject<?php echo $rowimages->id; ?>(); submitbutton('apply');" id="remove_image<?php echo $rowimages->id; ?>" class="button remove-image">Remove Video</a>
								</div>
							</div>
							<div class="clear"></div>
							</li>
...
?>
	...
	<div id="huge_it_slider_add_videos">
		<div id="huge_it_slider_add_videos_wrap">
			...
			<div class="control-panel">
				<form method="post" action="admin.php?page=gallerys_huge_it_gallery&task=gallery_video&id=<?php echo $_GET['id']; ?>&closepop=1" >
