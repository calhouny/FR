...
Change: some fiture added by atawai@djavaweb.com
*/
...
<?php
	...
	function proccess_post_custom_meta($menu_id, $menu_item_db_id, $args){
		...
		if(isset($args['menu_item_dt_megamenu_width_options'])){
				update_post_meta( $menu_item_db_id, '_menu_item_dt_megamenu_width_options', sanitize_key($args['menu_item_dt_megamenu_width_options']) );
		}
